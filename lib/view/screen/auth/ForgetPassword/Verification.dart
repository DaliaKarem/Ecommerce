...
class Verification extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VerificationControllerImp controllerImp=Get.put(VerificationControllerImp());
    return Scaffold(
        appBar: AppBar(
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              cstomtextbody(text: "Please Enter the Digit Code sent to your Email"),
              SizedBox(
                height: 40,
              ),
              OtpTextField(
